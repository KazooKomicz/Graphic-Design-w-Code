...
box{<-1,-0.1,-1>, <1,0, 1>
    ...
    texture{
        pigment{
                checker color red 0.8 green 0.4 blue 0
                        color red 0.7 green 0.3 blue 0
                quick_color red 0.8 green 0.4 blue 0
        }
        finish{diffuse 0.6 ambient 0.01 reflection 0.5 }
    }
}

sphere{<0,0,0>, 1.5
     texture{
        pigment{color rgbf<1,1,0, .3>
                quick_color red 1 green 1 blue 0
        }
        finish{diffuse 0.1 ambient 0.7 specular 0.0005 ior 1.5}
     }
...
sphere{<0, 0, 0>, 1
    texture{
        ...
        finish{diffuse 0.6 ambient 0.4 specular 0.0005 }
    }
    scale<2.,2.,2.>
...
cylinder{ <0,-1, 0>, <0, 1, 0>, 1
    texture{
        ...
        finish{diffuse 0.5 ambient 0.4 specular 0.0005 reflection 1}
    }
    scale<1.6, 2.33, 1.6>
